...
Мы будем часто редактировать код, обычно для быстрой работы хватает `nano`. Но мы хотим полноценную **IDE**, поэтому мы выбираем [[neovim]]

Для красивого терминала есть [[fastfetch]]  и можно заменить shell [[fish]]
